        ...
        'public' => function($collection)
            {
                $collection->directory('assets/stylesheets', function($collection)
                {
                    ...
                    $collection->add('css/skeleton.css');
                    $collection->add('css/base.css');
                    $collection->add('css/style.css');
                    $collection->add('css/superfish.css');
                    $collection->add('css/prettyPhoto.css');
                    $collection->add('css/flexslider.css');
                    $collection->add('css/reveal.css');
                    $collection->add('css/datePicker.css');
                    $collection->add('css/responsive.css');
                })->apply('UriRewriteFilter')->apply('CssMin');

                $collection->directory('assets/javascripts',function($collection){
                    $collection->add("js/jquery-1.9.1.min.js");
                    $collection->add("js/modernizr.custom.14583.js");
                    $collection->add("js/jquery-migrate-1.1.1.min.js");
                    $collection->add("js/jquery.easing.min.js");
                    $collection->add("js/jquery.flexslider.js");
                    $collection->add("js/jquery.prettyPhoto.js");
                    $collection->add("js/jquery.superfish.js");
                    $collection->add("js/jquery.reveal.js");
                    $collection->add("js/date.js");
                    $collection->add("js/jquery.datePicker.js");
                    $collection->add("js/jquery.dropkick-1.0.0.js");
                    $collection->add("js/jquery.tipsy.js");
                    $collection->add("js/jquery.carouFredSel-6.2.1.js");
                    $collection->add("js/jquery.isotope.min.js");
                    $collection->add("js/jquery.imagesloaded.min.js");
                    $collection->add("js/jquery.form.js");
                    $collection->add("js/custom.js");
                })->apply('Jsmin');
            },
